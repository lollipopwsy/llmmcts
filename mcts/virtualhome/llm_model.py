...
"""
        ...
        self.object_info = json.load(open('/mnt/wsy/test3/llm-mcts/data/object_info.json', 'r'))
    ...
    def construct_house_model(self):
        ...
        # save samples
        json.dump(object_positions, open("/mnt/wsy/test3/llm-mcts/data/object_all_positions.json", "w"))
        object_positions = {}
        ...
        # print(object_positions)   
        # save samples
        json.dump(object_positions, open("/mnt/wsy/test3/llm-mcts/data/furniture_all_positions.json", "w"))
...
if __name__ == '__main__':
    ...
    llm_agent.post_process('/mnt/wsy/test3/llm-mcts/data/object_all_positions.json', '/mnt/wsy/test3/llm-mcts/data/obj_commonsense.json')
    llm_agent.post_process('/mnt/wsy/test3/llm-mcts/data/furniture_all_positions.json', '/mnt/wsy/test3/llm-mcts/data/fur_commonsense.json')
